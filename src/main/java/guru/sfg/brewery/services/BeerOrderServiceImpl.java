...
public class BeerOrderServiceImpl implements BeerOrderService {
    ...
    public BeerOrderDto placeOrder(UUID customerId, BeerOrderDto beerOrderDto) {
        ...
        log.debug("customerOptional isPresent: " + customerOptional.isPresent());
        log.debug("customerOptional: " + customerOptional);
        if (customerOptional.isPresent()) {
            ...
            log.debug(" beerOrder.getBeerOrderLines(): " +  beerOrder.getBeerOrderLines());
